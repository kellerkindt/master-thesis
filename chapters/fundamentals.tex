...
Changes to files within containers are also stored in separately\footnote{\todo{overlayfs, similar to differentials in backups}}, which allows an image to be used by multiple containers at once.
...
\todo{basic words on UDP and TCP?}
