...
As describe before (see \autoref{workflow}), for easy deployment, the implementation of the management shall be executed from a Docker image \cite{docker:main}, as well as the stages.
