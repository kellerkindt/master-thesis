...
While fulfilling these requirements, the overall goal of the system is to increase productivity and hardware utilization, especially in times where the staff is absence.
The need to constantly monitor and interfere with the system shall be decreased by providing automated mechanisms where possible and appropriate.
