...
From the desired workflow, the following requirements can be extracted \todo{(shortened and incomplete due to early project stage)}:
...
\begin{itemize}
	...
	\item \todo{CI} Docker Image creation for the Java Binary as well as the program implementation, preferred in an automated fashion.
\end{itemize}
