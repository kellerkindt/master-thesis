...
All deadlines regarding the implementation and deployment were meat as planned.
A few of the milestones for documentation were pushed back slightly, because some parts took a bit longer to write about than anticipated first.
But, because enough time puffer was considered in final phase, the project was able finish in time without too much pressure as can be seen in \autoref{time_schedule}:
